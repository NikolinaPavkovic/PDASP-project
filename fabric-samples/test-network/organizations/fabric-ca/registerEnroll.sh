...
function createOrg() {
  ...
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:${2} --caname ca-org${1} -M ${PWD}/organizations/peerOrganizations/org${1}.example.com/users/User1@org${1}.example.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org${1}/tls-cert.pem
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://org${1}admin:org${1}adminpw@localhost:${2} --caname ca-org${1} -M ${PWD}/organizations/peerOrganizations/org${1}.example.com/users/Admin@org${1}.example.com/msp --tls.certfiles ${PWD}/organizations/fabric-ca/org${1}/tls-cert.pem
  { set +x; } 2>/dev/null
